...
# occupy
MAGNET_SCAN_PATTERNS = ["*/Mar24_2017_SecPos_0000.*",
                        "*/Mar24_2017_SecPos_0001.*",
                        "*/Mar29_2017_moved_0000.*"]
...
EXCEPTION_DATA = [(142.0, 74.0), (240.0, 305.0), (165.0, -124.0),
                  (142.0, 156.0), (240.0, 305.0), (135.0, 179.0),
                  (240.0, 305.0)]
...
EXCEPTION_NAME = ["Default", "PastRxWall", "CloseToColdSrcCtrlRoom",
                  ...
                  "MovedForMoreBFieldMeasurements", "NewDefault"]
...
EXCEPTION_PATTERN = [PAST_RX_WALL_PATTERNS, SURVEYING_PATTERNS,
                     ...
                     SECOND_MAGNET_SCAN_PATTERN, NEW_DEFAULT_PATTERNS]
